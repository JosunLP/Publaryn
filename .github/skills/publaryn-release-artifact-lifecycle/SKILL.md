...
description: 'Implement or review Publaryn release creation, artifact handling, publication, and pre-publication visibility rules. Use when working on quarantine-first publish flows, artifact upload/download, native adapter publish logic, release-state transitions, or related async follow-up work such as reindexing or scanning dispatch.'
